...
@app.route(route="GetAttentionListFile")
...
@app.route(route="GetHistoricalMetaFile")
...
@app.route(route="GetVendorDetailsFile")
...
@app.route(route="GetCompanyCodeDetailsFile")
...
@app.route(route="GetTaxCodeDescriptionFile")
...
@app.route(route="GetTaxCodeInfoFile")
...
@app.route(route="GetLegalEntitiesFile")
...
@app.route(route="GetCategoricalConfigFile")
